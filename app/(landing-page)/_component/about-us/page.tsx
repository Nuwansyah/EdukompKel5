...
const Aboutus = () => {
    return (
        <Container className="min-h-screen space-y-4 pb-10">
          <h2 className="font-bold text-center text-3xl py-4">Meet our web developer</h2>
          <div className=" w-full items-center">
            <div className="text-center pt-10">
              <div className="inline-block mb-4 relative shrink-0 rounded-[.95rem]">
                <Image 
                className="inline-block shrink-0 rounded-[.95rem] w-[130px] h-[150px]" 
            ...
            <div className="text-center pt-10">
              ...
              <div className="text-center">
                <a href="javascript:void(0)" className="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Puja Rahayu</a>
            ...
            <div className="text-center pt-10">
              ...
              <div className="text-center">
                <a href="javascript:void(0)" className="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">?</a>
                <span className="block text-sky-800 font-medium text-muted">?</span>
              </div>
            </div>
          </div>
        </Container>
